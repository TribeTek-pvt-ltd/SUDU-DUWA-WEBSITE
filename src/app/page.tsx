          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            ...
            <div className="lg:col-span-7">
              <div className="flex flex-wrap items-center gap-3 mb-8">
                <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-white/10 border border-white/20 text-aqua-400 font-bold tracking-[0.1em] text-[11px] uppercase backdrop-blur-md">
                  <Globe2 size={12} /> USA Imported Broodstock
                </div>
                <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-blue-500/10 border border-blue-500/20 text-blue-400 font-bold tracking-[0.1em] text-[11px] uppercase backdrop-blur-md">
                  <ShieldCheck size={12} /> SPF Certified
                </div>
              </div>
              
              <h1 className="text-5xl md:text-6xl lg:text-[72px] font-bold tracking-tight text-white mb-6 leading-[1.1]">
                ...
                <span className="text-transparent bg-clip-text bg-gradient-to-r from-aqua-400 to-blue-300 relative inline-block mt-2">
                  Prawn Hatchery
                  <svg className="absolute w-full h-3 -bottom-1 left-0 text-aqua-400/30" viewBox="0 0 100 10" preserveAspectRatio="none">
              ...
              <div className="flex flex-col sm:flex-row items-center gap-4">
                <Link 
                  href="/products"
                  className="group flex items-center justify-center gap-3 bg-white hover:bg-slate-100 text-[#05111c] px-8 py-4 rounded-full font-bold transition-all w-full sm:w-auto shadow-[0_0_30px_rgba(255,255,255,0.15)] hover:shadow-[0_0_40px_rgba(255,255,255,0.3)]"
                >
                ...
                <Link 
                  href="/about"
                  className="group flex items-center justify-center gap-3 bg-transparent hover:bg-white/5 text-white border border-white/20 px-8 py-4 rounded-full font-bold transition-all w-full sm:w-auto"
                >
                  Our Facilities
                </Link>
              </div>
              ...
              <div className="bg-white/10 backdrop-blur-xl border border-white/20 p-8 md:p-10 rounded-[30px] relative z-10 shadow-2xl">
                ...
                <form className="space-y-4">
                  <div>
                    ...
                    <input type="text" placeholder="Farm Name / Your Name" className="w-full bg-white/5 border border-white/10 rounded-xl px-5 py-3.5 text-white placeholder:text-slate-400 focus:outline-none focus:ring-2 focus:ring-aqua-500/50 transition-all" />
                  </div>
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                      <label className="sr-only">Phone Number</label>
                      <input type="tel" placeholder="Phone (WhatsApp)" className="w-full bg-white/5 border border-white/10 rounded-xl px-5 py-3.5 text-white placeholder:text-slate-400 focus:outline-none focus:ring-2 focus:ring-aqua-500/50 transition-all" />
                    </div>
                    <div>
                      <label className="sr-only">Required Quantity</label>
                      <input type="text" placeholder="Est. PL Quantity" className="w-full bg-white/5 border border-white/10 rounded-xl px-5 py-3.5 text-white placeholder:text-slate-400 focus:outline-none focus:ring-2 focus:ring-aqua-500/50 transition-all" />
                    </div>
                  </div>
                  <button type="submit" className="w-full bg-gradient-to-r from-aqua-500 to-blue-500 hover:from-aqua-400 hover:to-blue-400 text-white font-bold py-4 rounded-xl shadow-lg transition-all transform hover:-translate-y-0.5 mt-2 flex items-center justify-center gap-2">
          ...
          <div className="flex flex-col lg:flex-row items-center gap-24">
            ...
            <div className="flex-1 relative w-full mt-10 lg:mt-0">
              ...
              <div className="aspect-[4/5] rounded-[40px] overflow-hidden shadow-2xl relative z-10 border-8 border-white group">
                <img src="/assets/WhatsApp Image 2026-04-20 at 10.16.51.jpeg" alt="Hatchery Facility Operations" className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-700" />
      ...
      <section className="bg-[#05111c] py-32 relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 md:px-6 relative z-10 mt-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 auto-rows-[250px]">
            {/* Bento Box 1 - Large */}
            <div className="md:col-span-2 md:row-span-2 group relative bg-gradient-to-br from-white/10 to-white/5 border border-white/10 p-10 rounded-[40px] hover:bg-white/10 transition-all duration-500 overflow-hidden">
              <div className="absolute top-0 right-0 w-full h-full bg-gradient-to-br from-aqua-500/10 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
            ...
            {/* Bento Box 2 */}
            <div className="group relative bg-white/5 border border-white/10 p-8 rounded-[40px] hover:bg-white/10 transition-all duration-500 overflow-hidden">
              <div className="relative z-10 h-full flex flex-col justify-end">
            ...
            <div className="md:col-span-3 group relative bg-gradient-to-r from-aqua-900/40 to-[#05111c] border border-aqua-500/20 p-8 rounded-[40px] flex items-center justify-between overflow-hidden">
              ...
              <Link href="/farming-practices" className="hidden md:flex items-center gap-2 text-aqua-400 font-bold hover:text-white transition-colors relative z-10">
      ...
      <section className="bg-slate-50 py-32 relative">
        <div className="container mx-auto px-4 md:px-6">
          <div className="flex flex-col md:flex-row justify-between items-end gap-12 mb-20">
            ...
            <Link 
              href="/products" 
              className="group flex items-center gap-3 bg-slate-900 text-white px-8 py-4 rounded-full font-bold hover:bg-aqua-600 transition-all shadow-md hover:-translate-y-1"
            >
                ...
                {[
                  ...
                  <div key={i} className="bg-slate-50 p-8 rounded-[30px] border border-slate-100 shadow-sm hover:shadow-md transition-shadow">
                    <h3 className="text-lg font-bold text-slate-900 mb-3 flex items-start gap-4">
                      <div className="mt-1 bg-white p-1 rounded-full text-aqua-600 shrink-0 shadow-sm">
              ...
              <div className="bg-white p-12 md:p-16 rounded-[40px] shadow-2xl border border-slate-100 text-center relative overflow-hidden z-10">
                ...
                <div className="flex flex-col gap-4">
                  <a 
                    ...
                    className="flex items-center justify-center gap-3 bg-gradient-to-r from-aqua-500 to-blue-500 text-white px-8 py-5 rounded-2xl font-bold hover:shadow-lg transition-all hover:-translate-y-1"
                  >
