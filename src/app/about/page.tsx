...
export default function AboutPage() {
  return (
    <div className="flex flex-col gap-0 pb-0 bg-white">
      {/* Hero Section */}
      <section className="relative min-h-[70vh] flex items-center justify-center overflow-hidden bg-[#071828] pt-20">
              ...
              <div className="space-y-6 pt-6 border-t border-slate-100">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                  ...
                  <div className="bg-slate-50 p-6 rounded-2xl border border-slate-200">
                    ...
                    <p className="text-sm text-slate-600 leading-relaxed font-light">
                      Our advanced maturation and rearing unit, producing disease-free post-larvae (PL) ready for commercial stocking.
                    </p>
                  </div>
                </div>
              </div>
      ...
      <section className="bg-[#071828] py-24 relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 md:px-6 relative z-10">
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-12 text-center">
            <div className="space-y-4">
              ...
              <span className="text-slate-400 font-bold uppercase tracking-widest text-xs">Pathogen Free Status</span>
            </div>
            <div className="space-y-4">
              ...
              <span className="text-slate-400 font-bold uppercase tracking-widest text-xs">High-Yield Post-Larvae</span>
            </div>
            <div className="space-y-4">
              <span className="text-5xl md:text-6xl font-black text-transparent bg-clip-text bg-gradient-to-br from-aqua-400 to-blue-500 block">BSc</span>
              <span className="text-slate-400 font-bold uppercase tracking-widest text-xs">Expert Led Science</span>
            </div>
            <div className="space-y-4">
              ...
              <span className="text-slate-400 font-bold uppercase tracking-widest text-xs">Specialized Hatcheries</span>
            </div>
          </div>
        </div>
      </section>
